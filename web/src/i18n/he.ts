...
export const he: Record<TranslationKey, string> = {
  ...
  "ops.deviceRestarted": "הבקר הופעל מחדש",
  "ops.bootAt": "בשעה {time}",
  "ops.bootPowerOn": "הופעל כרגיל",
  "ops.bootExternal": "אופס חיצונית",
  "ops.bootSwRestart": "הופעל מחדש על ידי הקושחה",
  "ops.bootPanic": "התאושש מקריסה",
  "ops.bootWatchdog": "התאושש מתקיעה",
  "ops.bootBrownout": "התאושש מנפילת מתח",
  "ops.bootDeepSleep": "התעורר משינה עמוקה",
  "ops.bootUnknown": "הופעל מחדש מסיבה לא ידועה",
  "ops.sos": "מצוקה",
  ...
  "cfg.remotes.paired": "שלטים מותאמים",
  "cfg.remotes.unrecognised": "שלטים לא מזוהים",
  "cfg.remotes.pressHint":
    "לחץ על כל לחצן בשלט — הוא יופיע כאן תוך מספר שניות. כל לחצן מתאים את השלט כולו.",
  "cfg.remotes.noCandidates": "טרם התקבל שידור. לחץ על לחצן בשלט.",
  "cfg.remotes.buttonsSeen": "לחצנים",
  "cfg.remotes.lastSeen": "נראה לאחרונה",
  "cfg.remotes.events": "אירועים",
  "cfg.remotes.pairTitle": "התאמת שלט: {identity}",
  "cfg.remotes.namePlaceholder": "לדוגמה: השלט של אריאל",
  ...
  "explore.noEvents": "אין אירועים היום או אתמול.",
  ...
  "explore.loadMore": "טען 100 קודמים",
  "explore.loadAll": "טען הכול",
  "explore.loadingMore": "טוען אירועים קודמים…",
  "explore.allLoaded": "כל האירועים נטענו.",
  "explore.loadedCount": "{count} אירועים",
  ...
  "sched.next": "הבא: {what}",
  "sched.nextArm": "{side} ידרך ב {when}",
  "sched.nextDisarm": "{side} ינוטרל ב {when}",
  "sched.nextNone": "אין תזמון קרוב",
  "sched.overlapWarning":
    "יש חפיפה עם תזמון אחר באותו צד. שניהם יפעלו; הפעולה המאוחרת קובעת.",
  "sched.disabledProfile": "הפרופיל מושבת — שלב הדריכה לא יבוצע.",
